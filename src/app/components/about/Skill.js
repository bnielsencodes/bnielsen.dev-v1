  ...
  return (
    <>
      ...
      >
        ...
        >
          {props.skill.name === "react" && (
            <svg viewBox="0 0 128 128">
              <g className={styles[`svg--${props.skill.name}`]} fill="#fafafa">
          ...
          {props.skill.name === "next" && (
            <svg
              className={styles[`svg--${props.skill.name}`]}
              fill="#fafafa"
              viewBox="0 0 128 128"
            >
          ...
          {props.skill.name === "js" && (
            ...
            >
              <path
                className={styles[`svg--${props.skill.name}-color1`]}
                fill="#fafafa"
                d="M1.408 1.408h125.184v125.185H1.408z"
              ></path>
              <path
                className={styles[`svg--${props.skill.name}-color2`]}
                fill="#272727"
          ...
          {props.skill.name === "vite" && (
            ...
            >
              ...
              />
              <path
                className={styles[`svg--${props.skill.name}-stroke`]}
              ...
              <defs id="defs50">
                ...
                >
                  <stop
                    className={styles[`svg--${props.skill.name}-color3`]}
                    stopColor="#fafafa"
                    id="stop43"
                  />
                  <stop
                    className={styles[`svg--${props.skill.name}-color4`]}
                    offset=".0833"
                    stopColor="#fafafa"
                    id="stop45"
                  />
                  <stop
                    className={styles[`svg--${props.skill.name}-color5`]}
                    offset="1"
                    stopColor="#fafafa"
                    id="stop47"
                  />
          ...
          {props.skill.name === "css" && (
            ...
            >
              ...
              ></path>
              <path
                className={styles[`svg--${props.skill.name}-color6`]}
                fill="#272727"
                d="M64.048 23.435v13.831H30.64l-.277-3.108-.63-7.012-.331-3.711h34.646zm-.047 27.996v13.831H48.792l-.277-3.108-.631-7.012-.33-3.711h16.447z"
              ></path>
            </svg>
          )}
          {props.skill.name === "git" && (
            <svg viewBox="0 0 128 128">
              <path
                className={styles[`svg--${props.skill.name}`]}
                fill="#fafafa"
        ...
        <div className={`${styles.hex} ${styles[`hex--${props.skill.name}`]}`}>
        ...
        <div
          className={`${styles.border} ${
            styles[`border--${props.skill.name}`]
          }`}
        >
          <div
            className={`${styles.left} ${styles[`left--${props.skill.name}`]}`}
          ></div>
          <div
            className={`${styles.middle} ${
              styles[`middle--${props.skill.name}`]
            }`}
          ></div>
          <div
            className={`${styles.right} ${
              styles[`right--${props.skill.name}`]
            }`}
          ></div>
        </div>
      </div>
